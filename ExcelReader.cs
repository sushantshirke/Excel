    ...
    class ExcelReader
    {
        ...
        private void SendMailThroughGmail(string mailContent)
        {
            ...
            try
            {
                ...
                mail.From = new MailAddress("your mail@gmail.com"); //From Mail 

                mail.To.Add("to mail @gmail.com"); //To mail 
                mail.To.Add("to maiil@gmail.com"); //To mail
                ...
                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("youremail@gmail.com", "xysjjdj455"); //Your email and password
